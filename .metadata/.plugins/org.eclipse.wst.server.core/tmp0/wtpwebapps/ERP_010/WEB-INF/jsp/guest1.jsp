                                   ...
                                   <tbody>
                                   		<c:forEach items="${projects}" var="entry">
                                   			<tr>
                                   				...
                                   				<a href="ProjectGuestDetail?assignmentId=${entry.assignment_id}">${entry.assignmentName }</a>
                                          ...
                                          <td class="project-people">
                                            ...
                                            <a href="ProjectGuestDetail?assignmentId=${entry.assignment_id}" class="btn btn-white btn-sm"><i class="fa fa-folder"></i> 查看 </a>
                                          </td>
                                   			</tr>
                                   		</c:forEach>
                                   </tbody>
