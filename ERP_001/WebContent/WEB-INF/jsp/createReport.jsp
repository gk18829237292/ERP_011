            ...
            <div class="col-sm-6 col-sm-offset-3">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="signupForm" method="post" action="CreateReport" enctype="multipart/form-data">
                            <input type="hidden" name="taskid" value="${task.assignment_id} ">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">报告次数：</label>
                                <div class="col-sm-8">
                                    <input id="number" name="num" class="form-control" type="number" range="1,${task.num}">
